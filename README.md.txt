...
## About Project
This project imitates a real-world bookstore application, where each user can create their own account, buy and sell books.
...
It is also handy to users. They only need to provide ISBN code in order to find a book they want to sell.
...
### Run Maven
To check unit tests before running application type:
...
If you have already installed SDK 19 or above you can use it, otherwise click on Add SDK -> Download, and choose 19 or anything above. Click Apply and Ok.
...
## APIs
This project uses Google Api and Stripe Api, both for the convenience for you, have already implemented working keys, so you don't have to create your own.
But because they are free to use, the traffic is very limited, so it is not advised to make huge amount of requests.
